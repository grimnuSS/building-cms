		...
		<div class="col-xl-12 col-lg-12 mb-4">
			<div class="card">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">Yeni Projeler Ekleme Sayfası</h6>
				</div>
				<div class="card-body">
					<div class="content">
						<form action="<?php echo base_url("Yeniprojeler/save")?>" method="post" enctype="multipart/form-data">

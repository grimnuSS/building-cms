		...
		<div class="col-xl-12 col-lg-12 mb-4">
			<div class="card">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">Biten Projeler Düzenleme Sayfası</h6>
				</div>
				<div class="card-body">
					<div class="content">
						<?php
						$id = $this->uri->segment(3);
						$hizmetlerimiz_result = $this->Biten_Projeler->getBitenProjeler($id);?>
						<form action="<?php echo base_url("Bitenprojeler/update")?>" method="post" enctype="multipart/form-data">
							<?php
